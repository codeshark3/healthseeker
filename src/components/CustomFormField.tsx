...
{iconSrc && <Image src={iconSrc} width=
{24} height={24} alt={iconAlt || 'icon'} className="ml-2"/>}
...
<Input placeholder={placeholder} {...field}  className="shad-input border-0"/> 
      ...
      case FormFieldType.PHONE_INPUT:
        return <FormControl>
            <PhoneInput defaultCountry="GH" placeholder={placeholder} {...field}  international withCountryCallingCode  values={field.value as E164Number | undefined}  onChange={field.onChange} className="input-phone"/>
        </FormControl>
    //     break;
